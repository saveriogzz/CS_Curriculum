...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        self.shift_dict = {}
        low_lett = string.ascii_lowercase*2
        up_lett = string.ascii_uppercase*2
        alphabet = low_lett + up_lett

        for i in low_lett: self.shift_dict[i] = alphabet[alphabet.find(i) + shift]
        for j in up_lett: self.shift_dict[j] = alphabet[alphabet.find(j) + shift]
