...
WORDLIST_FILENAME = "/Users/saveriogzz/Desktop/6001x/Week 4 - Good programming practices/ProblemSet4/words.txt"
...
def isValidWord(word, hand, wordList):
    ...
    isValid = True
    if word in wordList:
        freq_aux = getFrequencyDict(word)
        for letter in word:
            if letter in hand.keys() and hand.get(letter) >= freq_aux.get(letter):
                isValid *= 1
                freq_aux[letter] -= 1
            else:
                isValid *= 0
...
def playGame(wordList):
    ...
    while True:
        input_letter = str(input("Enter n to deal a new hand, r to replay the last hand, or e to end game: "))
        input_history.append(input_letter)
